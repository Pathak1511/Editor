    ...
    <>
      <Box sx={{ display: "flex" }}>
        ...
        >
          ...
          <Divider />
          <List component="nav">
            <ListItems changeTab={changeTab} tab={tab} />
          </List>
        </Drawer>
        {/*  The main content */}
        {tab === "dashboard" ? (
          ...
          <>
            <RoomList
              url="https://codeflow-3ir4.onrender.com/v1/room/me/owner"
              btn="Enter"
              url2="https://codeflow-3ir4.onrender.com/v1/room/delete-community"
            />
          </>
        ) : tab === "member" ? (
          <>
            <RoomList
              url="https://codeflow-3ir4.onrender.com/v1/room/me/member"
              btn="Enter"
              url2="https://codeflow-3ir4.onrender.com/v1/member/delete-member"
            />
          </>
        ) : tab === "all-rooms" ? (
          ...
          <>
            <Request
              url="https://codeflow-3ir4.onrender.com/v1/room/all-community"
              btn="Send Request"
              isnotify="rooms"
            />
          </>
          ...
          <>
            <Request
              url="https://codeflow-3ir4.onrender.com/v1/Notification/get-notification"
              btn="Accept"
